# модель с комбинированным ядром вариант 2
import GPy
import numpy as np
import pandas as pd
...
for department in df.columns:
  ...
  kernel_combined = kernel_periodic + kernel_exp_quad + kernel_matern # Создание комбинированного ядра
...
predictions.to_excel("result/прогнозы_GP_Combo_2.xlsx")