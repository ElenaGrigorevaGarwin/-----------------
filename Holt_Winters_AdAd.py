#Holt-Winters выбор параметров ('add', 'add')
import pandas as pd
...
for column in df.columns[1:]:
    ...
    model = HWES(series, seasonal_periods=12, trend='add', seasonal='add')
    fitted = model.fit()
...
sales_forecast.to_excel('result/Прогнозы_Holt-Winters_AdAd.xlsx')