# комбинация линейного и периодического ядер
import GPy
import numpy as np
import pandas as pd
...
for department in df.columns:
  ...
  # Создание и обучение модели Гауссовского процесса с комбинацией линейного и периодического ядер
  kernel_linear = GPy.kern.Linear(input_dim=1)
  kernel_periodic = GPy.kern.StdPeriodic(input_dim=1)
  kernel = kernel_linear + kernel_periodic  
...
predictions.to_excel("result/прогнозы_GP_lin_Per.xlsx")