...
for department in df.columns:
    ...
    ets_model = sm.tsa.statespace.ExponentialSmoothing(sales_data,
                                                       trend='mul',  # 'add'  и 'multiplicative'
                                                       seasonal=12, # 4 и 12   
                                                       initialization_method= 'heuristic',   # метод инициализации - 'estimated', 'heuristic', 'concentrated'
...
predictions.to_excel("result/Прогнозы_ETS_HM12dt.xlsx")